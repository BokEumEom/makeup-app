...
import { useGameActions, useGameState } from "@/stores/game-state";

const { width: screenWidth } = Dimensions.get("screen");
export const Pause = () => {
  const pause = useImage(require("@/assets/flappybird-images/pause.png"));
  const play = useImage(require("@/assets/flappybird-images/play.png"));
