...
const DigitImages: Record<number, typeof require> = {
  0: require("@/assets/flappybird-images/0.png"),
  1: require("@/assets/flappybird-images/1.png"),
  2: require("@/assets/flappybird-images/2.png"),
  3: require("@/assets/flappybird-images/3.png"),
  4: require("@/assets/flappybird-images/4.png"),
  5: require("@/assets/flappybird-images/5.png"),
  6: require("@/assets/flappybird-images/6.png"),
  7: require("@/assets/flappybird-images/7.png"),
  8: require("@/assets/flappybird-images/8.png"),
  9: require("@/assets/flappybird-images/9.png"),
};
