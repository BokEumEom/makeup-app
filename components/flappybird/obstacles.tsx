...
import { useGameActions } from "@/stores/game-state";
...
const Obstacle: FC<{
  ...
  const pipeUp = useImage(require("@/assets/flappybird-images/pipe-green.png"));
  const pipeDown = useImage(require("@/assets/flappybird-images/pipe-green-down.png"));
